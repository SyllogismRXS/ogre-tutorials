...
bool TinyOgre::go(void)
{
    ...
    mResourcesCfg = "../share/dist/config/resources_d.cfg";
    //mPluginsCfg = "../share/dist/config/plugins_d.cfg";
    mPluginsCfg = "plugins_d.cfg";
#else
    std::cout << "NO DEBUG" << std::endl;
    mResourcesCfg = "../share/dist/config/resources.cfg";
    //mPluginsCfg = "../share/dist/config/plugins.cfg";
    mPluginsCfg = "../share/dist/config/plugins.cfg";
#endif
